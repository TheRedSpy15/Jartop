...
public class ChangePassword_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "ChangePassword"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ChangePassword_ESTest_scaffolding.class.getClassLoader() ,
      "ChangePassword",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ChangePassword_ESTest_scaffolding.class.getClassLoader()); 
